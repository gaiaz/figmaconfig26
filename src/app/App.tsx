...
const RESOURCE_LINKS = [
  {
    id: "glossary",
    title: "Glossario: capire Figma da zero",
    description: "Parole, feature e concetti base spiegati senza fuffa, perfetto per orientarsi durante la watch party.",
    label: "Apri glossario",
    href: "https://app.notion.com/p/gaiaz/Glossario-Capire-Figma-da-zero-38835028e5d0811c86b3fc7ca5af8bae",
    color: "#7B61FF",
  },
  {
    id: "timeline",
    title: "Timeline: ultimi 6 mesi di Figma",
    description: "Una timeline per recuperare il contesto recente e arrivare agli annunci con tutti i pezzi al posto giusto.",
    label: "Apri timeline",
    href: "https://app.notion.com/p/gaiaz/Timeline-Ultimi-6-mesi-di-Figma-38835028e5d0816f9207de4aa03fa1f9",
    color: ORANGE,
  },
  {
    id: "hub",
    title: "Config 2026 Watch Party Hub",
    description: "Il punto centrale con recap, materiali e link da condividere con chi vuole recuperare tutto dopo.",
    label: "Apri hub",
